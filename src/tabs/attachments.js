...
function createAttachmentTab(object) {
    ...
    if(object.isEditable()) {
        ...
        var upload = dom.button(null, "Upload", () => {
            uploadWindow.wrapper.classList.add("modal-visible")
        })
        ...
        el.appendChild(uploadWindow.wrapper)
    }
    ...
    function addImage(attachment) {
        ...
        var detailTD = dom.span(undefined, ["padding-left", "padding-right"])
    ...
    var content = dom.span(undefined, ["margin-top", "attachments"])
